...
export class ConfigureWalletComponent implements OnInit {
  ...
  loadLang() {
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg1')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg1 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg2')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg2 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg3')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg3 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg4')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg4 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg5')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg5 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg6')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg6 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg7')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg7 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg8')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg8 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg9')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg9 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg10')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg10 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg11')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg11 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg12')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg12 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg13')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg13 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg14')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg14 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg15')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg15 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg16')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg16 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg17')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg17 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg18')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg18 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg19')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg19 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg20')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg20 = res;
      });
    this.trans
      .get('CONFIGURE_WALLET_WARNINGS.msg21')
      .subscribe((res: string) => {
        // console.log(res);
        this.msg21 = res;
      });
