...
export class AddressBookComponent implements OnInit, AfterViewInit {
  ...
  async saveNewAddress() {
    if (!this.newAddressAccount || !this.newAddressName) return this.notificationService.sendError(this.msg2);
    ...
    if (!valid || valid.valid !== '1') return this.notificationService.sendWarning(this.msg4);
